package com.ssoftwares.pointandshoot.lesson16;
...
import com.ssoftwares.pointandshoot.CubeOld;

public class Lession16 extends GLSurfaceView implements Renderer {
    ...
    /**
     * Instance the CubeOld object and set the Activity Context
     ...
     */
    public Lession16(Context context) {
        super(context);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        gl.glScalef(0.8f, 0.8f, 0.8f); 			//Scale the CubeOld to 80 percent, otherwise it would be too large for the screen

        //Rotate around the axis based on the rotation matrix (rotation, x, y, z)
        gl.glRotatef(xrot, 1.0f, 0.0f, 0.0f);	//X
        gl.glRotatef(yrot, 0.0f, 1.0f, 0.0f);	//Y

        cube.draw(gl, filter);					//Draw the CubeOld
